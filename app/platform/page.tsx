...
import { ArrowRight, FlaskConical, Microscope, Activity, Beaker, ShieldCheck, Globe, TestTube, Target, Workflow } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  description: "Compvide's platform integrates complement biology expertise, functional assay design, and rigorous sample integrity control to generate reliable, physiologically relevant data for translational research.",
  keywords: ["complement assay platform", "CIMED diagnostics", "functional assays", "biomarker analysis", "clinical studies"],
}
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1">
              ...
              <div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4">
                  <div className="rounded-lg border border-border bg-card p-4 text-center">
                    <span className="block font-serif text-xl font-bold text-accent">CP</span>
                    <span className="mt-1 block text-xs text-muted-foreground">Classical Pathway</span>
                  </div>
                  <div className="rounded-lg border border-border bg-card p-4 text-center">
                    <span className="block font-serif text-xl font-bold text-accent">AP</span>
                    <span className="mt-1 block text-xs text-muted-foreground">Alternative Pathway</span>
                  </div>
                  <div className="rounded-lg border border-border bg-card p-4 text-center">
                    <span className="block font-serif text-xl font-bold text-accent">LP</span>
                    <span className="mt-1 block text-xs text-muted-foreground">Lectin Pathway</span>
                  </div>
                </div>
              </div>
              
              <div className="rounded-2xl bg-muted/50 p-8">
                <h3 className="font-semibold text-foreground">Functional & High-Serum Testing</h3>
                ...
                <ul className="mt-6 space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-foreground">High-serum and physiologic testing conditions to maintain biologically relevant activity</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-accent/10 text-accent">
                      <Target className="h-3.5 w-3.5" />
                    </div>
                    <span className="text-sm text-foreground">Pathway-specific activation and inhibition readouts for mechanistic clarity</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-accent/10 text-accent">
                      <Workflow className="h-3.5 w-3.5" />
                    </div>
                    <span className="text-sm text-foreground">Functional relevance over convenience assays, ensuring data supports translational decision-making</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="order-2 lg:order-1 rounded-2xl border border-border bg-card p-8">
                <h3 className="font-semibold text-foreground">Our quality systems support:</h3>
                <ul className="mt-6 space-y-4">
                  <li className="flex items-start gap-3">
                    <ShieldCheck className="mt-0.5 h-5 w-5 flex-shrink-0 text-accent" />
                    <span className="text-sm text-foreground">Preservation of functional complement activity</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ShieldCheck className="mt-0.5 h-5 w-5 flex-shrink-0 text-accent" />
                    <span className="text-sm text-foreground">Reproducibility across studies and time points</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ShieldCheck className="mt-0.5 h-5 w-5 flex-shrink-0 text-accent" />
                    <span className="text-sm text-foreground">Increased confidence in assay results and downstream interpretation</span>
                  </li>
                </ul>
                ...
                <div className="mt-8 flex items-center gap-3 rounded-lg bg-muted/50 p-4">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">Multi-Species Capability</p>
                    <p className="text-xs text-muted-foreground">Supporting translational continuity from preclinical to clinical studies</p>
                  </div>
                </div>
              </div>
        ...
        {/* Services Section */}
        <section id="services" className="bg-primary py-20 sm:py-24 scroll-mt-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-lg border border-primary-foreground/10 bg-primary-foreground/5 p-6">
                ...
                <div className="mt-4 space-y-2">
                  <p className="text-xs font-medium text-primary-foreground/90">Measured functional outputs:</p>
              ...
              <div className="rounded-lg border border-primary-foreground/10 bg-primary-foreground/5 p-6">
                ...
                <div className="mt-4 space-y-2">
                  <p className="text-xs font-medium text-primary-foreground/90">Services include:</p>
                  <ul className="text-xs text-primary-foreground/70 space-y-1">
              ...
              {/* Biomarker Programs */}
              <div id="biomarkers" className="rounded-lg border border-primary-foreground/10 bg-primary-foreground/5 p-6 scroll-mt-20">
                ...
                <div className="mt-4 space-y-2">
                  <p className="text-xs font-medium text-primary-foreground/90">Biomarkers include:</p>
                  <ul className="text-xs text-primary-foreground/70 space-y-1">
                    <li>• C3a, C4a, C5a</li>
                    <li>• Bb</li>
                    <li>• Soluble C5b-9</li>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div>
                ...
                <div className="mt-8">
                  <p className="text-sm font-medium text-foreground mb-4">Capabilities include assays for:</p>
                  <div className="grid grid-cols-2 gap-3">
                    {["C3, C4, Factor D, Factor B", "C1q, C1r, C1s", "MBL and Ficolins", "MASP-1, MASP-2, MASP-3"].map((item) => (
